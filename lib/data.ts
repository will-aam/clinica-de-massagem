...
// Mock data
const admins: Admin[] = [
  { id: "1", email: "admin@clinica.com", password: "123456" },
];
...
const checkIns: CheckIn[] = [
  {
    ...
    client_id: "1",
    package_id: "1",
    date_time: "2026-02-20T09:00:00Z",
  },
  {
    id: "2",
    client_id: "1",
    package_id: "1",
    date_time: "2026-02-21T10:00:00Z",
  },
  {
    id: "3",
    client_id: "3",
    package_id: "3",
    date_time: "2026-02-21T14:00:00Z",
  },
  {
    id: "4",
    client_id: "4",
    package_id: "4",
    date_time: "2026-02-22T11:00:00Z",
  },
  {
    id: "5",
    client_id: "1",
    package_id: "1",
    date_time: "2026-02-23T09:00:00Z",
  },
  {
    id: "6",
    client_id: "5",
    package_id: "5",
    date_time: "2026-02-24T08:30:00Z",
  },
  {
    id: "7",
    client_id: "4",
    package_id: "4",
    date_time: "2026-02-24T10:00:00Z",
  },
  {
    id: "8",
    client_id: "1",
    package_id: "1",
    date_time: "2026-02-24T11:00:00Z",
  },
  {
    id: "9",
    client_id: "3",
    package_id: "3",
    date_time: "2026-02-24T14:00:00Z",
  },
];
...
export function getActivePackageForClient(
  clientId: string,
): Package | undefined {
...
export function getCheckInsForClient(clientId: string): CheckIn[] {
  return checkIns
    .filter((ci) => ci.client_id === clientId)
    .sort(
      (a, b) =>
...
export function getActiveClientsCount(): number {
  const activeClientIds = new Set(
    packages.filter((p) => p.active).map((p) => p.client_id),
  );
...
export function getPackagesEndingSoon(): Package[] {
  return packages.filter(
    (p) => p.active && p.total_sessions - p.used_sessions <= 2,
  );
}
...
export function addPackageToClient(
  clientId: string,
...
export function performCheckIn(cpf: string): {
  success: boolean;
  client?: Client;
